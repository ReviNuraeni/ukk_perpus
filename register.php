                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <?php
                                            ...
                                            $email = $_POST['email'];
                                            $alamat = $_POST['alamat'];
                                            $no_tlp = $_POST['notelepon'];
                                            $level = $_POST['level'];
                                            $insert = mysqli_query($koneksi, "INSERT INTO user(nama,username,password,email,alamat,notelepon,level)
                                        ...
                                        <form method= "post">
                                            ...
                                            <label class="small mb-1">No.Telepon</label>
                                                <input class="form-control"  type="text" name="notelepon" placeholder="Masukan No.Telepon" />
                                            </div>
                                            <br>
                                            <div class="form-group">
